          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {marketStats.map((stat, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-sm p-6">
                ...
                <div className="text-purple-600 text-sm font-semibold">{stat.growth}</div>
              </div>
            ))}
          </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                    ...
                    <span className="font-bold text-purple-600">$15.2B</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
            ...
            {keyMetrics.map((metric, index) => (
              <div key={index} className="bg-gray-50 rounded-2xl p-6 text-center">
                ...
                <div className={`text-sm font-semibold ${
                  metric.change.startsWith('+') ? 'text-purple-600' : 'text-red-600'
                }`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {competitiveAdvantages.map((advantage, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-100 to-purple-100 rounded-full flex items-center justify-center mb-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <div className="text-xl font-bold text-purple-600">{round.amount}</div>
                      </div>
                      <div>
            ...
            {[
              ...
              <div key={index} className="bg-white rounded-2xl shadow-lg p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-purple-600 font-semibold">{phase.timeline}</p>
                </div>
